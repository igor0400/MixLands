  ...
  return (
     <div className="main-page mw1400 animate__animated animate__fadeIn">
        ...
        <section className="main-page__main">
           ...
           <div className="main__images animate__animated animate__fadeInRight">
              <img src={mainImg} alt="mixed" />
           </div>
        </section>
        <section className="features animate__animated animate__fadeInUp">
           ...
           <div className="features__cards">
              <div className="features__card">
                 ...
                 <p className="grey-p">
                    ...
                    сможете делать перевеоды из любого места в любое время
                    другому игроку.
                 </p>
              </div>
              <div className="features__card">
